...
class Broker(Protocol):
    ...
    # 발주용 시세 {"price": 현재가, "upper": 상한가|None, "lower": 하한가|None}.
    # 가격 평면 정책: 주문 지정가의 기준·밴드는 거래 평면(실시간 시세)에서만 —
    # 연구용 dataset 값 사용 금지 (2026-06-11 선물 만기일 상한가 거부 인시던트).
    ...
    def sell_resv_moo(self, symbol: str, qty: int) -> dict: ...                       # 미국 예약 매도(MOO)
