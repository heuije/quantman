      ...
      {busy && !cur ? (
        ...
        <>
          ...
          <p style={{ fontSize: 11, color: "var(--muted)", margin: "8px 2px 0" }}>
            Source: 미국 = FRED(세인트루이스 연준) · 일본 = 재무성(MOF) · 한국 = KRX 국고채
            지표물 · 중국 = ChinaBond(中债·국채등기결산기관 공식 커브) · 유로존 = ECB 산출 AAA등급
            유로지역 국채 스팟커브(독일 등 최고등급국 국채 기반 — 단일 국가 아님·정책금리 아님).
            전 국가 일별.
            {cc === "KR" ? " 한국은 KRX 지표물 3년·10년." : ""}
          </p>
        </>
      )}
    </div>
