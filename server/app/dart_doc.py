...
# 또한 프론트 차트·지표는 canon(공백제거)을 표준명과 '정확매칭'하므로, dart-fss가 XBRL 라벨로
# 주는 연결 접두·(손실) 접미·분기/반기 변형도 표준명으로 흡수해야 차트가 빠지지 않는다
# (예: '연결당기순이익' canon이면 순이익 그래프가 안 그려짐). ⚠ '연결범위변동'·'연결자본거래'처럼
# 연결이 붙은 별개 계정은 건드리지 않도록 정확한 키만 등록한다.
_DOC_CANON = {
    ...
    # 당기순이익 변형 — 연결 접두·(손실) 접미·분기/반기 → 표준 '당기순이익'(순이익 차트 매칭).
    "당기순이익(손실)": "당기순이익", "분기순이익": "당기순이익", "반기순이익": "당기순이익",
    "분기순이익(손실)": "당기순이익", "반기순이익(손실)": "당기순이익",
    "연결당기순이익": "당기순이익", "연결당기순이익(손실)": "당기순이익", "연결당기순손익": "당기순이익",
    "연결분기순이익": "당기순이익", "연결반기순이익": "당기순이익",
    # 총포괄손익 변형(표·병합 일관).
    "총포괄이익": "총포괄손익", "총포괄이익(손실)": "총포괄손익", "총포괄손익(손실)": "총포괄손익",
    "당기총포괄이익": "총포괄손익", "연결총포괄손익": "총포괄손익", "연결당기총포괄이익": "총포괄손익",
    "연결당기포괄이익": "총포괄손익", "연결기타포괄손익": "기타포괄손익",
}
